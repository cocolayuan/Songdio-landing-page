...
/**
 * Spell UI SlideUpText — installed from https://spell.sh/r/slide-up-text.json
 * (manual copy; shadcn CLI registry fetch failed in this environment).
 * className is applied last so callers can preserve layout (e.g. whitespace-nowrap).
 */
  ...
  (
    ...
    return (
      <motion.span
        className={cn(
          "flex",
          // lines: column stack; words/chars: wrap by default (caller can override with !flex-nowrap)
          split === "lines" ? "flex-col whitespace-pre" : "flex-wrap whitespace-pre-wrap",
          className,
        )}
        initial="hidden"
        ...
        {(split === "characters"
          ...
          return (
            ...
            >
              {wordObj.characters.map((char, charIndex) => (
                <span
                  className={cn(
                    ...
                    split === "lines" ? "whitespace-pre" : "whitespace-pre-wrap",
                  )}
                  key={charIndex}
                >
                  <motion.span
              ...
              {wordObj.needsSpace && (
                <span className="whitespace-pre-wrap relative overflow-hidden">
                  <motion.span
