import svgPaths from "./svg-5xr26uf8g9";
type FrameProps = {
  className?: string;
  color?: "white" | "green";
};
...
export default function Component({ className }: { className?: string }) {
  return (
    <div className={className || "bg-black h-[140px] relative w-[880px]"} data-name="点击设置纯音乐/歌词">
      <div className="absolute h-[140px] left-0 overflow-clip top-0 w-[880px]" data-name="composer-bar 1">
        ...
        <p className="[word-break:break-word] absolute font-['Inter:Regular',sans-serif] font-normal inset-[21.43%_74.55%_62.14%_3.86%] leading-[normal] not-italic text-[#66666d] text-[19px] whitespace-nowrap">Describe your song...</p>
        <div className="absolute contents left-[60px] top-[91px]" data-name="Group">
          <div className="absolute bg-[#1a1a1d] content-stretch flex gap-[8px] h-[38px] items-center justify-center left-[60px] pb-[9px] pl-[18px] pr-[16px] pt-[10px] rounded-[20px] top-[91px]">
            <div className="relative shrink-0 size-[16px]">
      ...
      <div className="absolute bg-[#404040] content-stretch flex items-center justify-center left-[10px] rounded-[30px] size-[38px] top-[90px]" data-name="icon">
